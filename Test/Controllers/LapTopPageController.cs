...
{
    public class LapTopPageController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<Product> phonesList = (from p in db.Products where p.productType.Equals("LapTop") orderby p.productID select p).Take(8).ToList();
        ...
        public ActionResult Paging(int page)
        {
            ...
            var phonesList = db.GetLapTopPaging(from, to);
